...
export default async function ProductPge({
  ...
  const newestProducts = await getData();
  ...
  return (
    <div className="product-container bg-white">
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        ...
        <div className="newest-container bg-white">
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 ">
          <span className="hover:text-violet-500">Our </span>
          <span className="hover:text-violet-500">Newest </span>
          <span className="hover:text-violet-500">Products</span>
        </h2>
      </div>
  ...
  return (
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
      <div className="flex justify-between items-center">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 " style={{paddingTop:200}}>
          {data.map((product) => (
            <div key={product._id} className="group relative">
              <div className="aspect-square w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75 lg:h-80 hover:scale-105 duration-200 ">
                <a href={`/product/${product.slug}`}>
